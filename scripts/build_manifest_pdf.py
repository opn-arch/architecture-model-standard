#!/usr/bin/env python3
"""Build a PDF for the Manifest subsystem docs."""
import sys
from pathlib import Path

# Reuse the build_arch_pdf infrastructure
sys.path.insert(0, str(Path(__file__).resolve().parent))
from build_arch_pdf import process_doc, render_mermaid, MERMAID_RE

import shutil
import subprocess

ROOT = Path(__file__).resolve().parent.parent
AUTHORED = ROOT / ".architecture" / "authored_docs" / "manifest"
SE_DOCS = ROOT / ".architecture-models" / "manifest" / "docs" / "se"
...
def main():
    ...
    output_pdf = ROOT / "manifest-docs.pdf"
    cmd = [

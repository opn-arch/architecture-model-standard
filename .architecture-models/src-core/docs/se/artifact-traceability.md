...
generated_at: 2026-08-19T17:00:09Z
...
# Artifact Traceability Map: Src (core)

## 1. Entity Inventory

| Entity Type | Count | Feeds SE Documents |
|-------------|-------|--------------------|
| Components | 16 | Logical Architecture, Maintenance Manual, Operations Manual, Interface Specification |
| Capabilities | 31 | ConOps, Functional Analysis, Requirements Analysis |
...
|---|---|---|---|---|---|---|---|---|
| ConOps | | **31** | | | | | **1** | |
| Functional Analysis | | **31** | **18** | | | | | |
| Interface Specification | **16** | | | — | | | | |
| Logical Architecture | **16** | | | — | | | | **1** |
...
| realizes | 16 | Component → Capability |
| contains | 16 | Unknown → Component |

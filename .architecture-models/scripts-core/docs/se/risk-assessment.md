...
generated_at: 2026-08-19T16:59:55Z
...
| RISK-CAP-CAP-15 | Capability | HIGH | Capability 'Add Sub Behaviors' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-16 | Capability | HIGH | Capability 'Bench Enrichment' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-17 | Capability | HIGH | Capability 'Enrich Sub Behaviors' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-18 | Capability | HIGH | Capability 'Generate Models Pdf' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-19 | Capability | HIGH | Capability 'Se Enrich' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-20 | Capability | HIGH | Capability 'Strip Sub Behaviors' has no realizing component | Allocate to component or remove if not needed |

...
# Artifact Traceability Map: architecture-model-standard / Authoring
...
|-------------------|-------|----------|
| depends-on | 4 | Component → Unknown, Unknown → Component, Unknown → Unknown |
...
**Total:** 282 files, 6.8MB, 0 reviewed

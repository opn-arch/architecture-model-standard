...
# Artifact Traceability Map: Src (pipeline)

## 1. Entity Inventory

| Entity Type | Count | Feeds SE Documents |
|-------------|-------|--------------------|
| Components | 21 | Logical Architecture, Maintenance Manual, Operations Manual, Interface Specification |
| Capabilities | 47 | ConOps, Functional Analysis, Requirements Analysis |
...
|---|---|---|---|---|---|---|---|---|
| ConOps | | **47** | | | | | **1** | |
| Functional Analysis | | **47** | **18** | | | | | |
| Interface Specification | **21** | | | — | | | | |
| Logical Architecture | **21** | | | — | | | | **1** |
...
|-------------------|-------|----------|
| depends-on | 140 | Component → Component |
| realizes | 21 | Component → Capability |
| contains | 21 | Unknown → Component |

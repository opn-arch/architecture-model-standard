...
# Artifact Traceability Map: architecture-model-standard / CLI
...
|-------------------|-------|----------|
| depends-on | 7 | Component → Unknown, Unknown → Unknown |
...
**Total:** 296 files, 6.8MB, 0 reviewed
...
| Requirements Analysis | 1 Requirements | — Not reviewed |  |

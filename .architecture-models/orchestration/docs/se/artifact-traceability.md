...
**Total:** 256 files, 6.7MB, 0 reviewed
...
| ConOps | 2 Capabilities | — Not reviewed |  |
| Functional Analysis | 2 Capabilities | — Not reviewed |  |
| Interface Specification | 3 Components, 3 Interfaces | — Not reviewed |  |
| Logical Architecture | 3 Components, 3 Interfaces | — Not reviewed |  |
| Maintenance Manual | 3 Components | — Not reviewed |  |
| Operations Manual | 3 Components | — Not reviewed |  |
| Requirements Analysis | 2 Capabilities, 1 Requirements | — Not reviewed |  |
| Risk Assessment |  | — Not reviewed |  |
| Use Cases |  | — Not reviewed |  |
| Verification & Validation | 1 Requirements | — Not reviewed |  |

<details>
<summary>Detailed entity-to-document mapping</summary>

**Component Specs:**
- Components: `COMP-5`, `COMP-5.1`, `COMP-5.2`

**ConOps:**
- Capabilities: `CAP-9`, `CAP-10`
...
- Components: `COMP-5`, `COMP-5.1`, `COMP-5.2`
- Interfaces: `IF-auto-COMP-5`, `IF-auto-COMP-5.1`, `IF-auto-COMP-5.2`

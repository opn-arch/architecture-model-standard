...
# Artifact Traceability Map: architecture-model-standard / Export
...
| Requirements | 2 | Requirements Analysis, Verification & Validation |
...
|-------------------|-------|----------|
| satisfies | 2 | Component → Requirement |
...
**Total:** 322 files, 6.9MB, 0 reviewed
...
| Requirements Analysis | 2 Requirements, 1 Capabilities | — Not reviewed |  |
| Risk Assessment |  | — Not reviewed |  |
| Use Cases |  | — Not reviewed |  |
| Verification & Validation | 2 Requirements | — Not reviewed |  |

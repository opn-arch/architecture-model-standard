...
generated_at: 2026-08-19T16:59:58Z
...
# Risk Assessment: Scripts (dev_simulation)
...
| RISK-CAP-CAP-22 | Capability | HIGH | Capability 'Runner' has no realizing component | Allocate to component or remove if not needed |

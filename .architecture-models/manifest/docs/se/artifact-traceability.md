...
**Total:** 230 files, 6.6MB, 0 reviewed
...
| Component Specs | 4 Components | — Not reviewed |  |
| ConOps | 1 Capabilities | — Not reviewed |  |
| Functional Analysis | 1 Capabilities | — Not reviewed |  |
| Interface Specification | 5 Interfaces, 4 Components | — Not reviewed |  |
| Logical Architecture | 5 Interfaces, 4 Components | — Not reviewed |  |
| Maintenance Manual | 4 Components | — Not reviewed |  |
| Operations Manual | 4 Components | — Not reviewed |  |
| Requirements Analysis | 4 Requirements, 1 Capabilities | — Not reviewed |  |
| Risk Assessment |  | — Not reviewed |  |
| Use Cases |  | — Not reviewed |  |
| Verification & Validation | 4 Requirements | — Not reviewed |  |

<details>
<summary>Detailed entity-to-document mapping</summary>

**Component Specs:**
- Components: `COMP-3`, `COMP-3.1`, `COMP-3.2`, `COMP-3.3`
...
- Components: `COMP-3`, `COMP-3.1`, `COMP-3.2`, `COMP-3.3`
- Interfaces: `IF-2`, `IF-4`, `IF-auto-COMP-3.1`, `IF-auto-COMP-3.2`, `IF-auto-COMP-3.3`
...
- Capabilities: `CAP-4`
- Requirements: `REQ-8`, `REQ-9`, `REQ-10`, `REQ-19`

...
# Risk Assessment: Projects (templatetags)
...
| RISK-CAP-CAP-15 | Capability | HIGH | Capability 'Cache' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-16 | Capability | HIGH | Capability 'I18N' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-17 | Capability | HIGH | Capability 'L10N' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-18 | Capability | HIGH | Capability 'Static' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-19 | Capability | HIGH | Capability 'Tz' has no realizing component | Allocate to component or remove if not needed |

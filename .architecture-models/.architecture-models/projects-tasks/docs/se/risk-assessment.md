...
# Risk Assessment: Projects (tasks)
...
| RISK-CAP-CAP-15 | Capability | HIGH | Capability 'Dummy' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-16 | Capability | HIGH | Capability 'Immediate' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-17 | Capability | HIGH | Capability 'Checks' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-18 | Capability | HIGH | Capability 'Exceptions' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-19 | Capability | HIGH | Capability 'Signals' has no realizing component | Allocate to component or remove if not needed |

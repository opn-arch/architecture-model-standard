...
| RISK-CAP-CAP-15 | Capability | HIGH | Capability 'Conf' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-16 | Capability | HIGH | Capability 'Converters' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-17 | Capability | HIGH | Capability 'Exceptions' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-18 | Capability | HIGH | Capability 'Resolvers' has no realizing component | Allocate to component or remove if not needed |

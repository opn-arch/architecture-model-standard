...
generated_at: 2026-08-19T16:56:48Z
...
|------|------|-------------|
| `.architecture/.architecture-models/.architecture-model.yaml` | 14.7KB | — |
...
| `.architecture-models/.architecture-model.yaml` | 65.3KB | — |
...
| Path | Size | LLM Reviewed |
|------|------|-------------|
| `.architecture-models/docs/se/artifact-traceability.md` | 93.0KB | — |
| `.architecture-models/docs/se/conops.md` | 3.9KB | — |
| `.architecture-models/docs/se/data-model.md` | 2.9KB | — |
| `.architecture-models/docs/se/functional-analysis.md` | 4.0KB | — |
| `.architecture-models/docs/se/index.md` | 709B | — |
| `.architecture-models/docs/se/interface-specification.md` | 3.0KB | — |
| `.architecture-models/docs/se/logical-architecture.md` | 33.6KB | — |
| `.architecture-models/docs/se/maintenance-manual.md` | 43.7KB | — |
| `.architecture-models/docs/se/operations-manual.md` | 2.6KB | — |
| `.architecture-models/docs/se/requirements-analysis.md` | 3.3KB | — |
| `.architecture-models/docs/se/risk-assessment.md` | 15.0KB | — |
| `.architecture-models/docs/se/security-analysis.md` | 2.5KB | — |
| `.architecture-models/docs/se/use-cases.md` | 4.5KB | — |
| `.architecture-models/docs/se/verification-validation.md` | 10.1KB | — |
...
| `.architecture-models/scripts-core/docs/se/artifact-traceability.md` | 4.0KB | — |
...
| `.architecture-models/scripts-dev-simulation/docs/se/artifact-traceability.md` | 4.2KB | — |
...
| `.architecture-models/src-core/docs/se/artifact-traceability.md` | 4.3KB | — |
...
| `.architecture-models/src-pipeline/docs/se/artifact-traceability.md` | 4.3KB | — |

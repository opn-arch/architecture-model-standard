...
generated_at: 2026-08-18T12:58:59Z
...
| RISK-CAP-CAP-15 | Capability | HIGH | Capability 'Constraint Detector' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-16 | Capability | HIGH | Capability 'From Artifacts' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-17 | Capability | HIGH | Capability 'From Code' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-18 | Capability | HIGH | Capability 'Route Detector' has no realizing component | Allocate to component or remove if not needed |
| RISK-CAP-CAP-19 | Capability | HIGH | Capability 'Table Parser' has no realizing component | Allocate to component or remove if not needed |
